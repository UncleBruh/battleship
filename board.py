...
class Board(tk.Frame):
	...
	def create_button_board(self):
		...
		self.init_img_btn = self.put_and_resize_photo(oriImg=self.config.init_img_btn, scale=1.5)

		self.final_img_btn = self.put_and_resize_photo(oriImg=self.config.final_img_btn, scale=1.25)
